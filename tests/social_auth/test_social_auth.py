...
class SocialTests(APITestCase):
    ...
    def setUp(self):
        ...
        self.user_with_valid_twitter_tokens = {
            "user": {
                "auth_token":
                "532504148-qllWlX5cm1bGylVMnJr023wzOmzHVIl1gCjJj6wy\
                     J3oNyC3y3ZlUlV4FeXGo3Kadgc9OSMVcM2YoWF9PiS8Jn"
            }
        }
    ...
    def test_login_with_valid_google_token(self):
        """
        Test login with an valid or expired google token
        """
        response = self.client.post(
            "/api/social/auth/google/", self.user_with_valid_google_token,
            format='json')
